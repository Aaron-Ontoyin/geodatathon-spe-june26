...
def _limitations() -> str:
    return (
        ...
        "transient reservoir/thermodynamic simulation. In particular the balance treats "
        "geothermal heat as fungible MW; a single-effect absorption chiller wants ~80-90 C drive "
        "heat, which is marginal at our ~77 C production, so absorption cooling may need a "
        "two-stage lift (or more compression cooling) than the energy balance implies.\n"
